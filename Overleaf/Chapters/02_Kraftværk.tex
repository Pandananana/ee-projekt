...
\section{Generator}
generatorn består af 2 motor en der skal forstille en turbine DC-Motor der så skal drive den anden motor som bruges som en generator. generator er en asynkron 14 polet motor med en 924 rpm/V
