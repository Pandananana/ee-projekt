###########################################################################
## Makefile generated for component 'pidTF2Code'. 
## 
## Makefile     : pidTF2Code.mk
## Generated on : Thu Jun 08 00:46:56 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pidTF2Code.elf
...
PRODUCT_NAME              = pidTF2Code
MAKEFILE                  = pidTF2Code.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/PC-mainxx/Documents/GitHub/ee-projekt/Calculations
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/PC-MAI~1/DOCUME~1/MATLAB/R2023a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pidTF2Code.elf
...
DEFINES_STANDARD = -DMODEL=pidTF2Code -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = pidTF2Code.o pidTF2Code_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/pidTF2Code_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/pidTF2Code_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pidTF2Code_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/pidTF2Code_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pidTF2Code.o : $(START_DIR)/pidTF2Code_ert_rtw/pidTF2Code.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pidTF2Code_data.o : $(START_DIR)/pidTF2Code_ert_rtw/pidTF2Code_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
